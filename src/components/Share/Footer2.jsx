...
import '../../assets/css/modules/category/Footer2.min.css'
...
function Footer2() {
  return (
    <div className="footer2__container">
        <div className="footer2__thumbnail">
            <img  src={logotipo} alt="" className="footer2__img" />
        </div>

        <div className="footer2__laws">
            <h3>Centro de Ayuda</h3>
            <h3>Terminos de servicio</h3>
            <h3>Politica de privacidad</h3>
        </div>

        <div className="footer2__ubication">
